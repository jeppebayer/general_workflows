...
def sfs_sp_build(config_file:str, gwf):
    """
    """
    # --------------------------------------------------
    #                  Configuration
    ...
    return gwf
def sfs_pop_workflow(config_file: str,gwf):
    """
    """
    # --------------------------------------------------
    #                  Configuration
    ...
    gwf.target_from_template(
        name = f'sfs_{TASK_ID}_{SPECIES_ID}_{POP_ID}'.replace("-","_"),
    ...
    for type_code in ["N","S","intergenic","intergenic_trimmed","intergenic_close_to_gene"]:
        gwf.target_from_template(
            name = f'sfs_{SPECIES_ID}_{POP_ID}_count_{type_code}'.replace("-","_"),
    ...
    gwf.target_from_template(
        name = f'sfs_{SPECIES_ID}_{POP_ID}_bam_cov_pass_bed'.replace("-","_"),
    ...
    gwf.target_from_template(
        name = f'sfs_{SPECIES_ID}_{POP_ID}_indel_bed'.replace("-","_"),
    ...
    gwf.target_from_template(
        name = f'sfs_{SPECIES_ID}_{POP_ID}_callable_bed'.replace("-","_"),
    ...
    gwf.target_from_template(
        name = f'sfs_{SPECIES_ID}_{POP_ID}_callable_summary'.replace("-","_"),
    ...
    gwf.target_from_template(
        name = f'sfs_{SPECIES_ID}_{POP_ID}_cds_monosites_NS_count'.replace("-","_"),
    ...
    gwf.target_from_template(
        name = f'sfs_{SPECIES_ID}_{POP_ID}_final_tsv_generate'.replace("-","_"),

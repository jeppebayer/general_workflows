...
# find /home/anneaa/EcoGenetics/people/anneaa/derived_dat_scripts/neutral_diversity_pipeline/migration_sim/Collembola/Entomobrya_nicoleti/fsc/simulated_SFS/decreasing_migration_100 -mindepth 3 -maxdepth 4 -type f -name "*bestlikelyhoods"| wc -l
